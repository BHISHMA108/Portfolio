...
function Skills() {
  ...
  return (
    <div id="skills" ref={ref} className="h-full my-[140px] relative">
      <h1 className="text-5xl lg:text-6xl font-bold mb-[20px] text-white mx-[20px] md:mx-[100px]">
        Skills
      </h1>

      {inView && (
        <video
          src="https://res.cloudinary.com/dst3yuj1w/video/upload/v1751910502/v3lite_rnzabx.webm"
          muted
          autoPlay
          loop
          playsInline
      ...
      <div className="grid grid-row-2 sm:grid-row-3 md:grid-cols-6 md:gap-7 items-center relative p-[20px] md:p-[100px]">
        <div className="col-span-2 hover:bg-[#006EBB] transition duration-500 p-2 rounded-3xl">
          <img
        ...
        <div className="hover:bg-[#00D9FD] transition duration-500 p-2 rounded-3xl">
          <img
        ...
        <div className="hover:bg-[#E44D26] transition duration-500 p-2 rounded-3xl">
          <img
        ...
        <div className="col-span-2 hover:bg-[#323330] transition duration-500 p-2 rounded-3xl">
          <img
        ...
        <div className="hover:bg-[#2965F1] transition duration-500 p-2 rounded-3xl">
          <img
        ...
        <div className="col-span-3 hover:bg-[#FFFFFF] transition duration-500 p-2 rounded-3xl">
          <img
        ...
        <div className="hover:bg-[#FFFFFF] transition duration-500 p-2 rounded-3xl">
          <img
        ...
        <div className="hover:bg-[#CA3132] transition duration-500 p-2 rounded-3xl">
          <img
        ...
        <div className="col-span-2 hover:bg-[#000000] transition duration-500 p-2 rounded-3xl">
          <img
        ...
        <div className="hover:bg-[#333333] transition duration-500 p-2 rounded-3xl">
          <img
        ...
        <div className="col-span-2 hover:bg-[#00ED64] transition duration-500 p-2 rounded-3xl">
          <img
